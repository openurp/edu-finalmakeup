...
[@b.form action="!addTakers" theme="list"]
   [@b.select items=tasks label="1)补考课程序号" option=r"${item.crn} ${item.course.name}" name="makeupCourse.crn" empty="..." required="false" style="width:300px"/]
   ...
   [@b.formfoot]
     <input type="hidden" name="semester.id" value="${Parameters['makeupTaker.makeupCourse.semester.id']}" value="提交"/>
     [@b.submit/]
   [/@]
[/@]
[@b.foot/]
